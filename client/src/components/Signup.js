                        ...
                        <div className="signup-form">
                            ...
                            <form method="POST" className="register-form" id="register-form">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" name="btech" id="btech" autoComplete="off"
                                        value={user.btech}
                                        onChange={handleInputs}
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="number" name="score" id="score" autoComplete="off"
                                        value={user.score}
                                        onChange={handleInputs}
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="number" name="twel" id="twel" autoComplete="off"
                                        value={user.twel}
                                        onChange={handleInputs}
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="number" name="tenth" id="tenth" autoComplete="off"
                                        value={user.tenth}
                                        onChange={handleInputs}
